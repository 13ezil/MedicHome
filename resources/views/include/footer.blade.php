      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="about-widget">
            ...
            <p>Be the part of the change in medical techno world by joining medichome</p>
              ...
              <li class="item">
                <div class="media">
                  <div class="media-body">
                    ...
                    <p>Make sure about medicine and keep your health more fit.</p>
                  </div>
                </div>
              </li>
              <li class="item">
